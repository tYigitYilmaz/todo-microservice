...
public class TodoResourceController {
    ...
    public List<Todo> getAllTodos(@PathVariable String username,
        ...
        Todo userIdGapper = todoHardcodedService.invokeUser(username);
        return todoHardcodedService.findAll(userIdGapper.getUserId());
    }
    ...
    @RequestMapping(value = "users/{username}/todos/{id}",method = RequestMethod.DELETE)
    ...
    public ResponseEntity<Todo> updateTodo(
      ...
      Todo userIdGapper = todoHardcodedService.invokeUser(username);
      Todo todoUpdated = todoHardcodedService.save(userIdGapper.getUserId(),todo);
    ...
    public ResponseEntity<Void> CreateTodo(
        ...
        Todo userIdGapper = todoHardcodedService.invokeUser(username);
        Todo createdTodo = todoHardcodedService.save(userIdGapper.getUserId(),todo);
